...
# cursorObj.execute("replace INTO  coin VALUES(1, 'BTC', 2, 3250)")
# con.commit()

# cursorObj.execute("replace INTO  coin VALUES(2, 'ETH', 5, 120)")
# con.commit()

# cursorObj.execute("replace INTO  coin VALUES(3, 'NEO', 5, 10)")
# con.commit()

# cursorObj.execute("replace INTO  coin VALUES(4, 'XMR', 3, 30)")
# con.commit()
...
def My_portfolio():
    ...
    def update_coin():
       ...
       con.commit()
       messagebox.showinfo("Portfolio Notification", "Coin update to Portfolio successfully!")
       reset()
    ...
    add_coin = Button(pycrypto, text = "Add Coin",  bg="green", fg="black",command=insert_coin, font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
    ...
    update_coin_txt = Button(pycrypto, text = "Update Coin",  bg="green", fg="black",command=update_coin, font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
    ...
    delete_coin_txt = Button(pycrypto, text = "Delete Coin",  bg="green", fg="black",command=delete_coin, font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
    ...
    Refresh = Button(pycrypto, text = "Refresh",  bg="green", fg="black",command=reset, font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
